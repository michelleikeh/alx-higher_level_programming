...
Project done in fulfilment for the requirement of the`ALX SE Full Stack Software Engineering Programme`. Object relational mapping ORM is used to map python to mysql database.
