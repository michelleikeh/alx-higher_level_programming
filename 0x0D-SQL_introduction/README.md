# MySQL - Introduction
Project done during **Full Stack Software Engineering studies** at **ALX **. It aims to teach about databases, relational databases, subqueries, tables, **MySQL** statements and functions.
