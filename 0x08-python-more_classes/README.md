...
Project done in fulfilment of the **ALX Full Stack Software Engineering programme**. It aims to teach about object oriented programming (OOP), Data Abstraction, Data Encapsulation, instances and classes attributes in **Python**.
